...
typedef volatile struct _Ifx_DMA
{
    ...
    Ifx_DMA_HRR HRR[128];                   /**< \brief 1800, DMA Channel Hardware Resource Register */
    Ifx_DMA_SUSENR SUSENR[128];             /**< \brief 1A00, DMA Suspend Enable Register */
    Ifx_DMA_SUSACR SUSACR[128];             /**< \brief 1C00, DMA Suspend Acknowledge Register */
    Ifx_DMA_TSR TSR[128];                   /**< \brief 1E00, DMA Transaction State Register */
    Ifx_DMA_CH CH[128];                     /**< \brief 2000, DMA channels */
