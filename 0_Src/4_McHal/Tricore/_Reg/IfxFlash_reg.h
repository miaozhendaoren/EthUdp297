...
/** \\brief  10CC, CBAB Configuration */
#define FLASH0_CBAB2_CFG /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_CFG*)0xF80020CCu)

/** Alias (User Manual Name) for FLASH0_CBAB2_CFG.
* To use register names with standard convension, please use FLASH0_CBAB2_CFG.
*/
#define	FLASH0_CBABCFG2	(FLASH0_CBAB2_CFG)

/** \\brief  10D0, CBAB Status */
#define FLASH0_CBAB2_STAT /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_STAT*)0xF80020D0u)

/** Alias (User Manual Name) for FLASH0_CBAB2_STAT.
* To use register names with standard convension, please use FLASH0_CBAB2_STAT.
*/
#define	FLASH0_CBABSTAT2	(FLASH0_CBAB2_STAT)

/** \\brief  10D4, CBAB FIFO TOP Entry */
#define FLASH0_CBAB2_TOP /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_TOP*)0xF80020D4u)

/** Alias (User Manual Name) for FLASH0_CBAB2_TOP.
* To use register names with standard convension, please use FLASH0_CBAB2_TOP.
*/
#define	FLASH0_CBABTOP2	(FLASH0_CBAB2_TOP)

/** \\brief  10D8, CBAB Configuration */
#define FLASH0_CBAB3_CFG /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_CFG*)0xF80020D8u)

/** Alias (User Manual Name) for FLASH0_CBAB3_CFG.
* To use register names with standard convension, please use FLASH0_CBAB3_CFG.
*/
#define	FLASH0_CBABCFG3	(FLASH0_CBAB3_CFG)

/** \\brief  10DC, CBAB Status */
#define FLASH0_CBAB3_STAT /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_STAT*)0xF80020DCu)

/** Alias (User Manual Name) for FLASH0_CBAB3_STAT.
* To use register names with standard convension, please use FLASH0_CBAB3_STAT.
*/
#define	FLASH0_CBABSTAT3	(FLASH0_CBAB3_STAT)

/** \\brief  10E0, CBAB FIFO TOP Entry */
#define FLASH0_CBAB3_TOP /*lint --e(923)*/ (*(volatile Ifx_FLASH_CBAB_TOP*)0xF80020E0u)

/** Alias (User Manual Name) for FLASH0_CBAB3_TOP.
* To use register names with standard convension, please use FLASH0_CBAB3_TOP.
*/
#define	FLASH0_CBABTOP3	(FLASH0_CBAB3_TOP)
...
/** \\brief  109C, ECC Read Register for ports */
#define FLASH0_ECCRP2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_ECCRP*)0xF800209Cu)

/** \\brief  10A0, ECC Read Register for ports */
#define FLASH0_ECCRP3 /*lint --e(923)*/ (*(volatile Ifx_FLASH_ECCRP*)0xF80020A0u)
...
/** \\brief  1040, OTP Protection Configuration for ports */
#define FLASH0_PROCONOTP2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONOTP*)0xF8002040u)

/** \\brief  1044, OTP Protection Configuration for ports */
#define FLASH0_PROCONOTP3 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONOTP*)0xF8002044u)
...
/** \\brief  1028, PFlash Protection Configuration for ports */
#define FLASH0_PROCONP2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONP*)0xF8002028u)

/** \\brief  102C, PFlash Protection Configuration for ports */
#define FLASH0_PROCONP3 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONP*)0xF800202Cu)
...
/** \\brief  1050, Write-Once Protection Configuration for ports */
#define FLASH0_PROCONWOP2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONWOP*)0xF8002050u)

/** \\brief  1054, Write-Once Protection Configuration for ports */
#define FLASH0_PROCONWOP3 /*lint --e(923)*/ (*(volatile Ifx_FLASH_PROCONWOP*)0xF8002054u)
...
/** \\brief  1078, Read Buffer Cfg 0 */
#define FLASH0_RDBCFG2_CFG0 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG0*)0xF8002078u)

/** Alias (User Manual Name) for FLASH0_RDBCFG2_CFG0.
* To use register names with standard convension, please use FLASH0_RDBCFG2_CFG0.
*/
#define	FLASH0_RDBCFG20	(FLASH0_RDBCFG2_CFG0)

/** \\brief  107C, Read Buffer Cfg 1 */
#define FLASH0_RDBCFG2_CFG1 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG1*)0xF800207Cu)

/** Alias (User Manual Name) for FLASH0_RDBCFG2_CFG1.
* To use register names with standard convension, please use FLASH0_RDBCFG2_CFG1.
*/
#define	FLASH0_RDBCFG21	(FLASH0_RDBCFG2_CFG1)

/** \\brief  1080, Read Buffer Cfg 2 */
#define FLASH0_RDBCFG2_CFG2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG2*)0xF8002080u)

/** Alias (User Manual Name) for FLASH0_RDBCFG2_CFG2.
* To use register names with standard convension, please use FLASH0_RDBCFG2_CFG2.
*/
#define	FLASH0_RDBCFG22	(FLASH0_RDBCFG2_CFG2)

/** \\brief  1084, Read Buffer Cfg 0 */
#define FLASH0_RDBCFG3_CFG0 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG0*)0xF8002084u)

/** Alias (User Manual Name) for FLASH0_RDBCFG3_CFG0.
* To use register names with standard convension, please use FLASH0_RDBCFG3_CFG0.
*/
#define	FLASH0_RDBCFG30	(FLASH0_RDBCFG3_CFG0)

/** \\brief  1088, Read Buffer Cfg 1 */
#define FLASH0_RDBCFG3_CFG1 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG1*)0xF8002088u)

/** Alias (User Manual Name) for FLASH0_RDBCFG3_CFG1.
* To use register names with standard convension, please use FLASH0_RDBCFG3_CFG1.
*/
#define	FLASH0_RDBCFG31	(FLASH0_RDBCFG3_CFG1)

/** \\brief  108C, Read Buffer Cfg 2 */
#define FLASH0_RDBCFG3_CFG2 /*lint --e(923)*/ (*(volatile Ifx_FLASH_RDB_CFG2*)0xF800208Cu)

/** Alias (User Manual Name) for FLASH0_RDBCFG3_CFG2.
* To use register names with standard convension, please use FLASH0_RDBCFG3_CFG2.
*/
#define	FLASH0_RDBCFG32	(FLASH0_RDBCFG3_CFG2)
...
/** \\brief  10FC, UBAB Configuration */
#define FLASH0_UBAB2_CFG /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_CFG*)0xF80020FCu)

/** Alias (User Manual Name) for FLASH0_UBAB2_CFG.
* To use register names with standard convension, please use FLASH0_UBAB2_CFG.
*/
#define	FLASH0_UBABCFG2	(FLASH0_UBAB2_CFG)

/** \\brief  1100, UBAB Status */
#define FLASH0_UBAB2_STAT /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_STAT*)0xF8002100u)

/** Alias (User Manual Name) for FLASH0_UBAB2_STAT.
* To use register names with standard convension, please use FLASH0_UBAB2_STAT.
*/
#define	FLASH0_UBABSTAT2	(FLASH0_UBAB2_STAT)

/** \\brief  1104, UBAB FIFO TOP Entry */
#define FLASH0_UBAB2_TOP /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_TOP*)0xF8002104u)

/** Alias (User Manual Name) for FLASH0_UBAB2_TOP.
* To use register names with standard convension, please use FLASH0_UBAB2_TOP.
*/
#define	FLASH0_UBABTOP2	(FLASH0_UBAB2_TOP)

/** \\brief  1108, UBAB Configuration */
#define FLASH0_UBAB3_CFG /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_CFG*)0xF8002108u)

/** Alias (User Manual Name) for FLASH0_UBAB3_CFG.
* To use register names with standard convension, please use FLASH0_UBAB3_CFG.
*/
#define	FLASH0_UBABCFG3	(FLASH0_UBAB3_CFG)

/** \\brief  110C, UBAB Status */
#define FLASH0_UBAB3_STAT /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_STAT*)0xF800210Cu)

/** Alias (User Manual Name) for FLASH0_UBAB3_STAT.
* To use register names with standard convension, please use FLASH0_UBAB3_STAT.
*/
#define	FLASH0_UBABSTAT3	(FLASH0_UBAB3_STAT)

/** \\brief  1110, UBAB FIFO TOP Entry */
#define FLASH0_UBAB3_TOP /*lint --e(923)*/ (*(volatile Ifx_FLASH_UBAB_TOP*)0xF8002110u)

/** Alias (User Manual Name) for FLASH0_UBAB3_TOP.
* To use register names with standard convension, please use FLASH0_UBAB3_TOP.
*/
#define	FLASH0_UBABTOP3	(FLASH0_UBAB3_TOP)
/** \}  */
/******************************************************************************/
/******************************************************************************/
