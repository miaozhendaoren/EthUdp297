...
{
    Ifx_SRC_SRCR RINT[8];                   /**< \brief 0, MULTICANr+ Service Request */
} Ifx_SRC_CANR;
...
typedef volatile struct _Ifx_SRC_GTM
{
    ...
    Ifx_SRC_SRCR SPEIRQ[4];                 /**< \brief 1C, GTM SPE Shared Service Request */
    Ifx_SRC_SRCR PSM[2][8];                 /**< \brief 2C, GTM PSM Shared Service Request */
    unsigned char reserved_6C[56];          /**< \brief 6C, \internal Reserved */
    ...
    Ifx_SRC_SRCR TIM[6][8];                 /**< \brief 180, GTM TIM Shared Service Request */
    unsigned char reserved_240[320];        /**< \brief 240, \internal Reserved */
    Ifx_SRC_SRCR MCS[6][8];                 /**< \brief 380, GTM MCS Shared Service Request */
    unsigned char reserved_440[320];        /**< \brief 440, \internal Reserved */
    Ifx_SRC_SRCR TOM[5][8];                 /**< \brief 580, GTM TOM Shared Service Request */
    unsigned char reserved_620[352];        /**< \brief 620, \internal Reserved */
    Ifx_SRC_SRCR ATOM[9][4];                /**< \brief 780, GTM ATOM Shared Service Request */
    unsigned char reserved_810[240];        /**< \brief 810, \internal Reserved */
    Ifx_SRC_SRCR MCSW0[6];                  /**< \brief 900, GTM Multi Channel Sequencer 0 Service Request */
    unsigned char reserved_918[40];         /**< \brief 918, \internal Reserved */
    Ifx_SRC_SRCR MCSW1[6];                  /**< \brief 940, GTM Multi Channel Sequencer 1 Service Request */
} Ifx_SRC_GTM;
...
{
    Ifx_SRC_SRCR SR[15];                    /**< \brief 0, SENT TRIG Service Request */
} Ifx_SRC_SENT;
...
{
    Ifx_SRC_CANR CANR[1];                   /**< \brief 0, CAN Service requests */
} Ifx_SRC_GCANR;
...
{
    Ifx_SRC_DSADC DSADC[10];                /**< \brief 0, DSADC Service requests */
} Ifx_SRC_GDSADC;
...
{
    Ifx_SRC_MSC MSC[3];                     /**< \brief 0, MSC Service requests */
} Ifx_SRC_GMSC;
...
{
    Ifx_SRC_VADCG G[11];                    /**< \brief 0, VADCG Service requests */
    unsigned char reserved_B0[112];         /**< \brief B0, \internal Reserved */
...
typedef volatile struct _Ifx_SRC
{
    ...
    unsigned char reserved_220[112];        /**< \brief 220, \internal Reserved */
    ...
    unsigned char reserved_330[32];         /**< \brief 330, \internal Reserved */
    Ifx_SRC_GSENT SENT;                     /**< \brief 350, SENT Service requests */
    unsigned char reserved_38C[84];         /**< \brief 38C, \internal Reserved */
    ...
    unsigned char reserved_700[496];        /**< \brief 700, \internal Reserved */
    ...
    Ifx_SRC_GCANR CANR;                     /**< \brief 940, CAN Service requests */
    ...
    unsigned char reserved_BA0[64];         /**< \brief BA0, \internal Reserved */
    ...
    unsigned char reserved_1F58[168];       /**< \brief 1F58, \internal Reserved */
} Ifx_SRC;
/** \}  */
/******************************************************************************/
/** \}  */
