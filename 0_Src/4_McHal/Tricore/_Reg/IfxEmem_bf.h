...
/** \\brief  Length for Ifx_EMEM_SBRCTR_Bits.ACGSXAM0 */
#define IFX_EMEM_SBRCTR_ACGSXAM0_LEN (1)

/** \\brief  Mask for Ifx_EMEM_SBRCTR_Bits.ACGSXAM0 */
#define IFX_EMEM_SBRCTR_ACGSXAM0_MSK (0x1)

/** \\brief  Offset for Ifx_EMEM_SBRCTR_Bits.ACGSXAM0 */
#define IFX_EMEM_SBRCTR_ACGSXAM0_OFF (8)
...
/** \\brief  Length for Ifx_EMEM_TILECONFIGXM_Bits.XAM0 */
#define IFX_EMEM_TILECONFIGXM_XAM0_LEN (2)

/** \\brief  Mask for Ifx_EMEM_TILECONFIGXM_Bits.XAM0 */
#define IFX_EMEM_TILECONFIGXM_XAM0_MSK (0x3)

/** \\brief  Offset for Ifx_EMEM_TILECONFIGXM_Bits.XAM0 */
#define IFX_EMEM_TILECONFIGXM_XAM0_OFF (0)
...
/** \\brief  Length for Ifx_EMEM_TILESTATEXM_Bits.XAM0 */
#define IFX_EMEM_TILESTATEXM_XAM0_LEN (2)

/** \\brief  Mask for Ifx_EMEM_TILESTATEXM_Bits.XAM0 */
#define IFX_EMEM_TILESTATEXM_XAM0_MSK (0x3)

/** \\brief  Offset for Ifx_EMEM_TILESTATEXM_Bits.XAM0 */
#define IFX_EMEM_TILESTATEXM_XAM0_OFF (0)
/** \}  */
/******************************************************************************/
/******************************************************************************/
#endif /* IFXEMEM_BF_H */
