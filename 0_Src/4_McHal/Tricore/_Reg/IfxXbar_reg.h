...
/** \\brief  2C4, Arbiter Control Register 10 */
#define XBAR_ARBCON10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBCON10*)0xF87002C4u)
...
/** \\brief  184, Arbiter Control Register */
#define XBAR_ARBITER5_ARBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBCON*)0xF8700184u)

/** Alias (User Manual Name) for XBAR_ARBITER5_ARBCON.
* To use register names with standard convension, please use XBAR_ARBITER5_ARBCON.
*/
#define	XBAR_ARBCON5	(XBAR_ARBITER5_ARBCON)

/** \\brief  19C, Debug Address Register */
#define XBAR_ARBITER5_DBADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER5_DBADD*)0xF870019Cu)

/** Alias (User Manual Name) for XBAR_ARBITER5_DBADD.
* To use register names with standard convension, please use XBAR_ARBITER5_DBADD.
*/
#define	XBAR_DBADD5	(XBAR_ARBITER5_DBADD)

/** \\brief  198, Debug Control Register */
#define XBAR_ARBITER5_DBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBCON*)0xF8700198u)

/** Alias (User Manual Name) for XBAR_ARBITER5_DBCON.
* To use register names with standard convension, please use XBAR_ARBITER5_DBCON.
*/
#define	XBAR_DBCON5	(XBAR_ARBITER5_DBCON)

/** \\brief  1A0, Debug Mask Address Register */
#define XBAR_ARBITER5_DBMADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER5_DBMADD*)0xF87001A0u)

/** Alias (User Manual Name) for XBAR_ARBITER5_DBMADD.
* To use register names with standard convension, please use XBAR_ARBITER5_DBMADD.
*/
#define	XBAR_DBMADD5	(XBAR_ARBITER5_DBMADD)

/** \\brief  194, Error/Debug Capture Register */
#define XBAR_ARBITER5_ERR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERR*)0xF8700194u)

/** Alias (User Manual Name) for XBAR_ARBITER5_ERR.
* To use register names with standard convension, please use XBAR_ARBITER5_ERR.
*/
#define	XBAR_ERR5	(XBAR_ARBITER5_ERR)

/** \\brief  190, Error/Debug Address Capture Register */
#define XBAR_ARBITER5_ERRADDR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERRADDR*)0xF8700190u)

/** Alias (User Manual Name) for XBAR_ARBITER5_ERRADDR.
* To use register names with standard convension, please use XBAR_ARBITER5_ERRADDR.
*/
#define	XBAR_ERRADDR5	(XBAR_ARBITER5_ERRADDR)

/** \\brief  188, Arbiter Priority Register */
#define XBAR_ARBITER5_PRIOH /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOH*)0xF8700188u)

/** Alias (User Manual Name) for XBAR_ARBITER5_PRIOH.
* To use register names with standard convension, please use XBAR_ARBITER5_PRIOH.
*/
#define	XBAR_PRIOH5	(XBAR_ARBITER5_PRIOH)

/** \\brief  18C, Arbiter Priority Register */
#define XBAR_ARBITER5_PRIOL /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOL*)0xF870018Cu)

/** Alias (User Manual Name) for XBAR_ARBITER5_PRIOL.
* To use register names with standard convension, please use XBAR_ARBITER5_PRIOL.
*/
...
/** \\brief  284, Arbiter Control Register */
#define XBAR_ARBITER9_ARBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBCON*)0xF8700284u)

/** Alias (User Manual Name) for XBAR_ARBITER9_ARBCON.
* To use register names with standard convension, please use XBAR_ARBITER9_ARBCON.
*/
#define	XBAR_ARBCON9	(XBAR_ARBITER9_ARBCON)

/** \\brief  29C, Debug Address Register */
#define XBAR_ARBITER9_DBADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER9_DBADD*)0xF870029Cu)

/** Alias (User Manual Name) for XBAR_ARBITER9_DBADD.
* To use register names with standard convension, please use XBAR_ARBITER9_DBADD.
*/
#define	XBAR_DBADD9	(XBAR_ARBITER9_DBADD)

/** \\brief  298, Debug Control Register */
#define XBAR_ARBITER9_DBCON /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBCON*)0xF8700298u)

/** Alias (User Manual Name) for XBAR_ARBITER9_DBCON.
* To use register names with standard convension, please use XBAR_ARBITER9_DBCON.
*/
#define	XBAR_DBCON9	(XBAR_ARBITER9_DBCON)

/** \\brief  2A0, Debug Mask Address Register */
#define XBAR_ARBITER9_DBMADD /*lint --e(923)*/ (*(volatile Ifx_XBAR_ARBITER9_DBMADD*)0xF87002A0u)

/** Alias (User Manual Name) for XBAR_ARBITER9_DBMADD.
* To use register names with standard convension, please use XBAR_ARBITER9_DBMADD.
*/
#define	XBAR_DBMADD9	(XBAR_ARBITER9_DBMADD)

/** \\brief  294, Error/Debug Capture Register */
#define XBAR_ARBITER9_ERR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERR*)0xF8700294u)

/** Alias (User Manual Name) for XBAR_ARBITER9_ERR.
* To use register names with standard convension, please use XBAR_ARBITER9_ERR.
*/
#define	XBAR_ERR9	(XBAR_ARBITER9_ERR)

/** \\brief  290, Error/Debug Address Capture Register */
#define XBAR_ARBITER9_ERRADDR /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERRADDR*)0xF8700290u)

/** Alias (User Manual Name) for XBAR_ARBITER9_ERRADDR.
* To use register names with standard convension, please use XBAR_ARBITER9_ERRADDR.
*/
#define	XBAR_ERRADDR9	(XBAR_ARBITER9_ERRADDR)

/** \\brief  288, Arbiter Priority Register */
#define XBAR_ARBITER9_PRIOH /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOH*)0xF8700288u)

/** Alias (User Manual Name) for XBAR_ARBITER9_PRIOH.
* To use register names with standard convension, please use XBAR_ARBITER9_PRIOH.
*/
#define	XBAR_PRIOH9	(XBAR_ARBITER9_PRIOH)

/** \\brief  28C, Arbiter Priority Register */
#define XBAR_ARBITER9_PRIOL /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOL*)0xF870028Cu)

/** Alias (User Manual Name) for XBAR_ARBITER9_PRIOL.
* To use register names with standard convension, please use XBAR_ARBITER9_PRIOL.
*/
...
/** \\brief  2DC, Debug Address Register 10 */
#define XBAR_DBADD10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBADD10*)0xF87002DCu)

/** \\brief  2D8, Debug Control Register 10 */
#define XBAR_DBCON10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBCON10*)0xF87002D8u)

/** \\brief  2E0, Debug Mask Address Register 10 */
#define XBAR_DBMADD10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBMADD10*)0xF87002E0u)

/** \\brief  40C, Debug Trigger Event Status Register */
#define XBAR_DBSAT /*lint --e(923)*/ (*(volatile Ifx_XBAR_DBSAT*)0xF870040Cu)

/** \\brief  2D4, Error/Debug Capture Register 10 */
#define XBAR_ERR10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERR10*)0xF87002D4u)

/** \\brief  2D0, Error/Debug Address Capture Register 10 */
#define XBAR_ERRADDR10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_ERRADDR10*)0xF87002D0u)
...
/** \\brief  2C8, Arbiter Priority Register 10 */
#define XBAR_PRIOH10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOH10*)0xF87002C8u)

/** \\brief  2CC, Arbiter Priority Register 10 */
#define XBAR_PRIOL10 /*lint --e(923)*/ (*(volatile Ifx_XBAR_PRIOL10*)0xF87002CCu)
/** \}  */
/******************************************************************************/
/******************************************************************************/
#endif /* IFXXBAR_REG_H */
