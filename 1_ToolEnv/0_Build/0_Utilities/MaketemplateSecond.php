...
<?php echo $cFile->objFilePathName ?>: <?php echo $cFile->filePathName  ?> <?php echo $mfile->targetSecondToolchainConfigMakeFilePathName . "\n"?>
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_SECOND) $(HEX_BIN_SECOND) $(MAP_FILE_SECOND) $(LIB_OBJ_SECOND)
...
<?php echo $asmFile->objFilePathName ?>: <?php echo $asmFile->filePathName  ?> <?php echo $mfile->targetSecondToolchainConfigMakeFilePathName . "\n"?>
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_SECOND) $(HEX_BIN_SECOND) $(MAP_FILE_SECOND) $(LIB_OBJ_SECOND)
