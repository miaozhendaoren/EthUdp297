...
IfxScu_Req_In IfxScu_REQ0_P15_4_IN = {&MODULE_SCU, 0, {&MODULE_P15, 4}};
IfxScu_Req_In IfxScu_REQ10_P14_3_IN = {&MODULE_SCU, 10, {&MODULE_P14, 3}};
IfxScu_Req_In IfxScu_REQ11_P20_9_IN = {&MODULE_SCU, 11, {&MODULE_P20, 9}};
IfxScu_Req_In IfxScu_REQ12_P11_10_IN = {&MODULE_SCU, 12, {&MODULE_P11,10}};
IfxScu_Req_In IfxScu_REQ13_P15_5_IN = {&MODULE_SCU, 13, {&MODULE_P15, 5}};
IfxScu_Req_In IfxScu_REQ14_P02_1_IN = {&MODULE_SCU, 14, {&MODULE_P02, 1}};
IfxScu_Req_In IfxScu_REQ15_P14_1_IN = {&MODULE_SCU, 15, {&MODULE_P14, 1}};
IfxScu_Req_In IfxScu_REQ16_P15_1_IN = {&MODULE_SCU, 16, {&MODULE_P15, 1}};
IfxScu_Req_In IfxScu_REQ1_P15_8_IN = {&MODULE_SCU, 1, {&MODULE_P15, 8}};
IfxScu_Req_In IfxScu_REQ2_P10_2_IN = {&MODULE_SCU, 2, {&MODULE_P10, 2}};
IfxScu_Req_In IfxScu_REQ3_P10_3_IN = {&MODULE_SCU, 3, {&MODULE_P10, 3}};
IfxScu_Req_In IfxScu_REQ4_P10_7_IN = {&MODULE_SCU, 4, {&MODULE_P10, 7}};
IfxScu_Req_In IfxScu_REQ5_P10_8_IN = {&MODULE_SCU, 5, {&MODULE_P10, 8}};
IfxScu_Req_In IfxScu_REQ6_P02_0_IN = {&MODULE_SCU, 6, {&MODULE_P02, 0}};
IfxScu_Req_In IfxScu_REQ7_P00_4_IN = {&MODULE_SCU, 7, {&MODULE_P00, 4}};
IfxScu_Req_In IfxScu_REQ8_P33_7_IN = {&MODULE_SCU, 8, {&MODULE_P33, 7}};
IfxScu_Req_In IfxScu_REQ9_P20_0_IN = {&MODULE_SCU, 9, {&MODULE_P20, 0}};
