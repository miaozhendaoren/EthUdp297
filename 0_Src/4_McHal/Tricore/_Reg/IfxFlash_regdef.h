...
typedef struct _Ifx_FLASH_FSR_Bits
{
    ...
    unsigned int P2BUSY:1;                  /**< \brief [5:5] Program Flash PF2 Busy (rh) */
    unsigned int P3BUSY:1;                  /**< \brief [6:6] Program Flash PF3 Busy (rh) */
...
typedef struct _Ifx_FLASH_MARP_Bits
{
    ...
    unsigned int SELP2:1;                   /**< \brief [2:2] PFLASH Bank PF2 Selection (rw) */
    unsigned int SELP3:1;                   /**< \brief [3:3] PFLASH Bank PF3 Selection (rw) */
...
typedef volatile struct _Ifx_FLASH
{
    ...
    Ifx_FLASH_PROCONP PROCONP[4];           /**< \brief 1020, PFlash Protection Configuration for ports */
    ...
    Ifx_FLASH_PROCONOTP PROCONOTP[4];       /**< \brief 1038, OTP Protection Configuration for ports */
    Ifx_FLASH_PROCONWOP PROCONWOP[4];       /**< \brief 1048, Write-Once Protection Configuration for ports */
    ...
    Ifx_FLASH_RDB RDBCFG[4];                /**< \brief 1060, Read Buffer Configuration for ports */
    Ifx_FLASH_ECCW ECCW;                    /**< \brief 1090, ECC Write Register */
    Ifx_FLASH_ECCRP ECCRP[4];               /**< \brief 1094, ECC Read Register for ports */
    ...
    Ifx_FLASH_CBAB CBAB[4];                 /**< \brief 10B4, Corrected Bits Address Buffer for ports */
    Ifx_FLASH_UBAB UBAB[4];                 /**< \brief 10E4, Uncorrectable Bits Address Buffer for ports */
    unsigned char reserved_1114[44];        /**< \brief 1114, \internal Reserved */
