...
{
    unsigned int reserved_0:1;              /**< \brief \internal Reserved */
    unsigned int PS1:1;                     /**< \brief [1:1] Pad Supply for pins [5:4] (rw) */
    unsigned int reserved_2:30;             /**< \brief \internal Reserved */
} Ifx_P_LPCR2_Bits;
...
{
    unsigned int reserved_0:1;              /**< \brief \internal Reserved */
    unsigned int PS1:1;                     /**< \brief [1:1] Pad Supply for pins [7:6] (rw) */
    unsigned int reserved_2:30;             /**< \brief \internal Reserved */
} Ifx_P_LPCR3_Bits;
...
typedef volatile struct _Ifx_P
{
    ...
    unsigned char reserved_A4[72];          /**< \brief B0, \internal Reserved */
