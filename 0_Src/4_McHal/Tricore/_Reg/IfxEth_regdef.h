...
typedef struct _Ifx_ETH_OPERATION_MODE_Bits
{
    ...
    unsigned int RFD2:1;                    /**< \brief [22:22] MSB of Threshold for Deactivating Flow Control (r) */
    unsigned int RFA2:1;                    /**< \brief [23:23] MSB of Threshold for Activating Flow Control (r) */
...
typedef struct _Ifx_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_Bits
{
    ...
    unsigned int RDESLA_32bit:30;           /**< \brief [31:2] Start of Receive List (rw) */
...
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int TDESLA_32bit:30;           /**< \brief [31:2] Start of Transmit List (rw) */
