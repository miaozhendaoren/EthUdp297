...
/** \\brief  Arbiter Control Register 10 */
typedef struct _Ifx_XBAR_ARBCON10_Bits
{
...
/** \\brief  Debug Address Register */
typedef struct _Ifx_XBAR_ARBITER5_DBADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS:29;                /**< \brief [30:2] Debug Address Boundary (rw) */
    unsigned int reserved_31:1;             /**< \brief \internal Reserved */
...
/** \\brief  Debug Mask Address Register */
typedef struct _Ifx_XBAR_ARBITER5_DBMADD_Bits
{
    unsigned int reserved_0:2;              /**< \brief \internal Reserved */
    unsigned int ADDRESS:29;                /**< \brief [30:2] Debug Address Boundary (rw) */
    unsigned int reserved_31:1;             /**< \brief \internal Reserved */
...
/** \\brief  Debug Address Register */
typedef struct _Ifx_XBAR_ARBITER9_DBADD_Bits
{
    unsigned int reserved_0:29;             /**< \brief \internal Reserved */
    unsigned int ADDRESS:1;                 /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
...
/** \\brief  Debug Mask Address Register */
typedef struct _Ifx_XBAR_ARBITER9_DBMADD_Bits
{
    unsigned int reserved_0:29;             /**< \brief \internal Reserved */
    unsigned int ADDRESS:1;                 /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
...
{
    unsigned int ADDRESS:32;                /**< \brief [31:0] Debug Address Mask Register (rw) */
} Ifx_XBAR_ARBITERD_DBMADD_Bits;

/** \\brief  Debug Address Register 10 */
typedef struct _Ifx_XBAR_DBADD10_Bits
{
    unsigned int reserved_0:29;             /**< \brief \internal Reserved */
    unsigned int ADDRESS:1;                 /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
} Ifx_XBAR_DBADD10_Bits;

/** \\brief  Debug Control Register 10 */
typedef struct _Ifx_XBAR_DBCON10_Bits
{
...
/** \\brief  Debug Mask Address Register 10 */
typedef struct _Ifx_XBAR_DBMADD10_Bits
{
    unsigned int reserved_0:29;             /**< \brief \internal Reserved */
    unsigned int ADDRESS:1;                 /**< \brief [29:29] Debug Address Boundary (rw) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
} Ifx_XBAR_DBMADD10_Bits;
...
typedef struct _Ifx_XBAR_DBSAT_Bits
{
    ...
    unsigned int SCI9:1;                    /**< \brief [9:9] SCI Debug Trigger Event Status (rwh) */
    unsigned int SCI10:1;                   /**< \brief [10:10] SCI Debug Trigger Event Status (rwh) */
...
/** \\brief  Error/Debug Capture Register 10 */
typedef struct _Ifx_XBAR_ERR10_Bits
{
...
/** \\brief  Error/Debug Address Capture Register 10 */
typedef struct _Ifx_XBAR_ERRADDR10_Bits
{
    unsigned int ADDR:32;                   /**< \brief [31:0] Transaction Address (rh) */
} Ifx_XBAR_ERRADDR10_Bits;
...
typedef struct _Ifx_XBAR_IDINTEN_Bits
{
    ...
    unsigned int ENSCI5:1;                  /**< \brief [5:5] Enable ID Error from SCI5 (rw) */
    ...
    unsigned int ENSCI9:1;                  /**< \brief [9:9] Enable ID Error from SCI9 (rw) */
    unsigned int ENSCI10:1;                 /**< \brief [10:10] Enable ID Error from SCI10 (rw) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_IDINTSAT_Bits
{
    ...
    unsigned int reserved_3:1;              /**< \brief \internal Reserved */
    unsigned int IDSCI4:1;                  /**< \brief [4:4] Transaction ID Error from SCI4 Status (rwh) */
    unsigned int IDSCI5:1;                  /**< \brief [5:5] Transaction ID Error from SCI5 Status (rwh) */
    ...
    unsigned int IDSCI9:1;                  /**< \brief [9:9] Transaction ID Error from SCI9 Status (rwh) */
    unsigned int IDSCI10:1;                 /**< \brief [10:10] Transaction ID Error from SCI10 Status (rwh) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_INTSAT_Bits
{
    ...
    unsigned int SCSCI5:1;                  /**< \brief [5:5] Starvation Error from SCI5 Status (rwh) */
    ...
    unsigned int SCSCI9:1;                  /**< \brief [9:9] Starvation Error from SCI9 Status (rwh) */
    unsigned int SCSCI10:1;                 /**< \brief [10:10] Starvation Error from SCI10 Status (rwh) */
    unsigned int reserved_11:4;             /**< \brief \internal Reserved */
    ...
    unsigned int PRSCI5:1;                  /**< \brief [21:21] Protocol Error from SCI5 Status (rwh) */
    ...
    unsigned int PRSCI9:1;                  /**< \brief [25:25] Protocol Error from SCI9 Status (rwh) */
    unsigned int PRSCI10:1;                 /**< \brief [26:26] Protocol Error from SCI10 Status (rwh) */
...
/** \\brief  Arbiter Priority Register 10 */
typedef struct _Ifx_XBAR_PRIOH10_Bits
{
...
/** \\brief  Arbiter Priority Register 10 */
typedef struct _Ifx_XBAR_PRIOL10_Bits
{
...
/** \\brief  Arbiter objects */
typedef volatile struct _Ifx_XBAR_ARBITER5
{
    Ifx_XBAR_ARBCON ARBCON;                 /**< \brief 0, Arbiter Control Register */
    Ifx_XBAR_PRIOH PRIOH;                   /**< \brief 4, Arbiter Priority Register */
    Ifx_XBAR_PRIOL PRIOL;                   /**< \brief 8, Arbiter Priority Register */
...
/** \\brief  Arbiter objects */
typedef volatile struct _Ifx_XBAR_ARBITER9
{
    Ifx_XBAR_ARBCON ARBCON;                 /**< \brief 0, Arbiter Control Register */
    Ifx_XBAR_PRIOH PRIOH;                   /**< \brief 4, Arbiter Priority Register */
    Ifx_XBAR_PRIOL PRIOL;                   /**< \brief 8, Arbiter Priority Register */
...
typedef volatile struct _Ifx_XBAR
{
    ...
    unsigned char reserved_164[32];         /**< \brief 164, \internal Reserved */
    Ifx_XBAR_ARBITER5 ARBITER5;             /**< \brief 184, Arbiter objects */
    unsigned char reserved_1A4[32];         /**< \brief 1A4, \internal Reserved */
    ...
    unsigned char reserved_264[32];         /**< \brief 264, \internal Reserved */
    Ifx_XBAR_ARBITER9 ARBITER9;             /**< \brief 284, Arbiter objects */
    unsigned char reserved_2A4[32];         /**< \brief 2A4, \internal Reserved */
    Ifx_XBAR_ARBCON10 ARBCON10;             /**< \brief 2C4, Arbiter Control Register 10 */
    Ifx_XBAR_PRIOH10 PRIOH10;               /**< \brief 2C8, Arbiter Priority Register 10 */
    Ifx_XBAR_PRIOL10 PRIOL10;               /**< \brief 2CC, Arbiter Priority Register 10 */
    Ifx_XBAR_ERRADDR10 ERRADDR10;           /**< \brief 2D0, Error/Debug Address Capture Register 10 */
    Ifx_XBAR_ERR10 ERR10;                   /**< \brief 2D4, Error/Debug Capture Register 10 */
    Ifx_XBAR_DBCON10 DBCON10;               /**< \brief 2D8, Debug Control Register 10 */
    Ifx_XBAR_DBADD10 DBADD10;               /**< \brief 2DC, Debug Address Register 10 */
    Ifx_XBAR_DBMADD10 DBMADD10;             /**< \brief 2E0, Debug Mask Address Register 10 */
    unsigned char reserved_2E4[292];        /**< \brief 2E4, \internal Reserved */
