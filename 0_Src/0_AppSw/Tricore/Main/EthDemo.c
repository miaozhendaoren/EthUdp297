...
const uint8 myMacAddress[6] = {0x00, 0x11, 0x22, 0x55, 0x33, 0x22};
...
void EthDemo_init(void)
{
    /* configure Ethermac */
    {
        ...
        const IfxEth_Config   config = {
            	myMacAddress[0],        /* MAC address */
            	myMacAddress[1],        /* MAC address */
            	myMacAddress[2],        /* MAC address */
            	myMacAddress[3],        /* MAC address */
            	myMacAddress[4],        /* MAC address */
            	myMacAddress[5],        /* MAC address */
            &IfxEth_Phy_Pef7071_init,                    /* Pointer to the PHY init function */
            &IfxEth_Phy_Pef7071_link,                    /* Pointer to the PHY link function, in this struct it is not a boolean but a uint32 function */
            &pins,                                       /* Pointer to the pin config */
