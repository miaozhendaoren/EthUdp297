...
/** \\brief  Length for Ifx_ETH_OPERATION_MODE_Bits.RFA2 */
#define IFX_ETH_OPERATION_MODE_RFA2_LEN (1)

/** \\brief  Mask for Ifx_ETH_OPERATION_MODE_Bits.RFA2 */
#define IFX_ETH_OPERATION_MODE_RFA2_MSK (0x1)

/** \\brief  Offset for Ifx_ETH_OPERATION_MODE_Bits.RFA2 */
#define IFX_ETH_OPERATION_MODE_RFA2_OFF (23)
...
/** \\brief  Length for Ifx_ETH_OPERATION_MODE_Bits.RFD2 */
#define IFX_ETH_OPERATION_MODE_RFD2_LEN (1)

/** \\brief  Mask for Ifx_ETH_OPERATION_MODE_Bits.RFD2 */
#define IFX_ETH_OPERATION_MODE_RFD2_MSK (0x1)

/** \\brief  Offset for Ifx_ETH_OPERATION_MODE_Bits.RFD2 */
#define IFX_ETH_OPERATION_MODE_RFD2_OFF (22)
...
/** \\brief  Length for
 * Ifx_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_Bits.RDESLA_32bit */
#define IFX_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_RDESLA_32BIT_LEN (30)

/** \\brief  Mask for Ifx_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_Bits.RDESLA_32bit */
#define IFX_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_RDESLA_32BIT_MSK (0x3fffffff)

/** \\brief  Offset for
 * Ifx_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_Bits.RDESLA_32bit */
#define IFX_ETH_RECEIVE_DESCRIPTOR_LIST_ADDRESS_RDESLA_32BIT_OFF (2)
...
/** \\brief  Length for
 * Ifx_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_Bits.TDESLA_32bit */
#define IFX_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_TDESLA_32BIT_LEN (30)

/** \\brief  Mask for Ifx_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_Bits.TDESLA_32bit */
#define IFX_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_TDESLA_32BIT_MSK (0x3fffffff)

/** \\brief  Offset for
 * Ifx_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_Bits.TDESLA_32bit */
#define IFX_ETH_TRANSMIT_DESCRIPTOR_LIST_ADDRESS_TDESLA_32BIT_OFF (2)
