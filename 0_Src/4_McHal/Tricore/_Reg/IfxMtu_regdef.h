...
typedef struct _Ifx_MTU_MEMMAP_Bits
{
    ...
    unsigned int CPU0DCMAP:1;               /**< \brief [18:18] CPU0 DCACHE Mapping (TC29x TC1.6P) (rwh) */
    unsigned int CPU0DTMAP:1;               /**< \brief [19:19] CPU0 DTAG Mapping (TC29x TC1.6P) (rh) */
...
typedef struct _Ifx_MTU_MEMSTAT0_Bits
{
    ...
    unsigned int CPU0DSAIU:1;               /**< \brief [14:14] CPU0 DCACHE Partial AutoInitialize Underway (TC29x TC1.6P) (rh) */
    ...
    unsigned int CPU0DTAIU:1;               /**< \brief [19:19] CPU0 DTAG MBIST AutoInitialize Underway (TC29x TC1.6P) (rh) */
    unsigned int CPU1DS2AIU:1;              /**< \brief [20:20] CPU1 DCACHE Partial AutoInitialize Underway (TC29x Second DS Bank) (rh) */
    unsigned int CPU2DS2AIU:1;              /**< \brief [21:21] CPU2 DCACHE Partial AutoInitialize Underway (TC29x Second DS Bank) (rh) */
...
typedef struct _Ifx_MTU_MEMTEST0_Bits
{
    ...
    unsigned int reserved_18:1;             /**< \brief \internal Reserved */
    unsigned int CPU0DTEN:1;                /**< \brief [19:19] CPU0 TC1.6P DTAG MBIST Controller Memory Enable (rwh) */
    unsigned int CPU1DS2EN:1;               /**< \brief [20:20] CPU1 TC1.6P DSPR2 MBIST Controller Memory Enable (TC29x Only) (rwh) */
    unsigned int CPU2DS2EN:1;               /**< \brief [21:21] CPU2 TC1.6P DSPR2 MBIST Controller Memory Enable (TC29x Only) (rwh) */
...
typedef struct _Ifx_MTU_MEMTEST1_Bits
{
    ...
    unsigned int ERAY1OEN:1;                /**< \brief [9:9] ERAY1 OBF Controller Memory Enable (rwh) */
    unsigned int ERAY1TEN:1;                /**< \brief [10:10] ERAY1 TBF Controller Memory Enable (rwh) */
    unsigned int ERAY1MEN:1;                /**< \brief [11:11] ERAY1 MBF Controller Memory Enable (rwh) */
    ...
    unsigned int EMEMU0EN:1;                /**< \brief [30:30] EMEM Upper 0 (XCM) Controller Memory Enable (rwh) */
    unsigned int EMEMU1EN:1;                /**< \brief [31:31] EMEM Upper 1 (XCM) Controller Memory Enable (rwh) */
} Ifx_MTU_MEMTEST1_Bits;

/** \\brief  Memory MBISTEnable Register 2 */
typedef struct _Ifx_MTU_MEMTEST2_Bits
{
    unsigned int EMEMU2EN:1;                /**< \brief [0:0] EMEM Upper 2 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU3EN:1;                /**< \brief [1:1] EMEM Upper 3 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU4EN:1;                /**< \brief [2:2] EMEM Upper 4 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU5EN:1;                /**< \brief [3:3] EMEM Upper 5 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU6EN:1;                /**< \brief [4:4] EMEM Upper 6 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU7EN:1;                /**< \brief [5:5] EMEM Upper 7 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU8EN:1;                /**< \brief [6:6] EMEM Upper 8 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU9EN:1;                /**< \brief [7:7] EMEM Upper 9 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU10EN:1;               /**< \brief [8:8] EMEM Upper 10 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU11EN:1;               /**< \brief [9:9] EMEM Upper 11 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU12EN:1;               /**< \brief [10:10] EMEM Upper 12 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU13EN:1;               /**< \brief [11:11] EMEM Upper 13 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU14EN:1;               /**< \brief [12:12] EMEM Upper 14 (XCM) Controller Memory Test Enable (rwh) */
    unsigned int EMEMU15EN:1;               /**< \brief [13:13] EMEM Upper 15 (XCM) Controller Memory Test Enable (rwh) */
